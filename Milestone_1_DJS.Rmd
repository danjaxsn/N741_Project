...
Representation of what a plot showing the number of CKDu tweets per country could potentially look like.
```{r, include=FALSE}
#Made up data to be used in making histogram below. 
...
```
```{r}
#Make Histogram of CKDu tweets per country
ggplot(data = CKDu_Tweets, aes(x = country, y = tweets)) + geom_bar(stat = "identity")+
  ggtitle("Number of CKDu Tweets per Country")
```
